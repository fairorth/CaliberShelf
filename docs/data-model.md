...
| `collection_guides` | owner | app + guide seeders | Master Collection Guides (00038): name, thesis, source document, version. Seeded: "Grand Seiko" (`seed-gs-guide`, v1.2) and "Swiss Artisans" (`seed-swiss-guide`, JLC × Vacheron Constantin, v1.0) |
