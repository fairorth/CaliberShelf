...
- Latest applied migration: `00035_add_watch_images_path.sql` (see docs/data-model.md for the table catalog). `00036_add_brand_wishlist.sql` is written but NOT yet applied.
